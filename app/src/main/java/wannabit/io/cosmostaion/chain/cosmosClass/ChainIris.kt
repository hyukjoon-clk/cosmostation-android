...
@Parcelize
class ChainIris : BaseChain(), Parcelable {
    ...
    override var grpcHost: String = "grpc-iris.mainnet.cosmoslabs.kr"
    override var lcdUrl: String = "https://lcd-iris.mainnet.cosmoslabs.kr/"
}