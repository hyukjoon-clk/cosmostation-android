...
class ChainGnoTestnet : ChainGno(), Parcelable {
    ...
    override var mainUrl: String = "https://rpc.pearl.testnets.gno.land:443"
    override var gnoIndexerUrl: String = "https://indexer.pearl.testnets.gno.land/graphql/query"
}