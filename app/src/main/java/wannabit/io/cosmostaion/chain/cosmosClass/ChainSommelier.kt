...
@Parcelize
class ChainSommelier : BaseChain(), Parcelable {
    ...
    override var grpcHost: String = "grpc-sommelier.mainnet.cosmoslabs.kr"
    override var lcdUrl: String = "https://lcd-sommelier.mainnet.cosmoslabs.kr/"
}