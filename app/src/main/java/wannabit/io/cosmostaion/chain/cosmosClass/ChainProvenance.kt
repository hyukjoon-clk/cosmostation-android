...
@Parcelize
class ChainProvenance : BaseChain(), Parcelable {
    ...
    override var grpcHost: String = "grpc-provenance.mainnet.cosmoslabs.kr"
    override var lcdUrl: String = "https://lcd-provenance.mainnet.cosmoslabs.kr/"
}